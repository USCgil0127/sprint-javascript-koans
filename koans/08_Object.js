describe('Object에 대해서 학습합니다.', function () {
  ...
  */
  ...
  // http://www.w3bai.com/ko/jsref/jsref_repeat.html
  ...
  it('Object를 함수의 인자로 전달할 경우, reference가 전달됩니다.', function () {
    ...
    // 어째서 false 임?? 둘은 전혀 다른 객체들일 텐데... 헷갈린다.
    expect('Jared Leto' in copiedObj.twins).to.equal(true);
